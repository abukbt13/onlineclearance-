        ...
        <div>
            ...
            <form class="form" method="post" action="adminprocessor.php">
                ...
                <div class="form-group">
                    ...
                    <select name="sportscategory" required id="" class="form-control">
                ...
                <div class="d-flex mt-4 align-items-center flex-row  justify-content-center">
                    <button type="submit" name="sports_clearance" class="btn w-100 btn-primary text-uppercase">Update Academic Clearance</button>
